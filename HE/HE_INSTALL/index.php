...
div#mapholder{
	...
	<script type="text/javascript">
		...
		function manageInsert1(){
			...
			$.getJSON( "http://human-ecosystems.com/HE/ecosystem/getRandomMessage.php?w=" + citycode,function(data){
		...
		var connections;
    	var WIDTH = 1280;//3840;//window.innerWidth;
    ...
    var WIDTHmap=1280,HEIGHTmap=480;
    var mapWidthmap=2e3;
