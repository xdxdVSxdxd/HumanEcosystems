...
<body>
	...
	<script src="../ecosystem/viz/js/jquery-2.0.3.min.js"></script>
    <script>
    ...
    $(document).ready(function(){
		...
		italiaMaterial=new THREE.MeshLambertMaterial({color:16777215,opacity:1,map:THREE.ImageUtils.loadTexture("../ecosystem/viz/img/<?php echo($www); ?>.png",{},function(){italia.material.map.needsUpdate=true})});
		...
		$.getJSON("../ecosystem/viz/getContentForMap.php?w=<?php echo($www); ?>",{},function(e){
			for(var t=0;t<e.length;t++){
