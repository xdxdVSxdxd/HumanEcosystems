...
<script>
  ...
  ga('send', 'pageview');
		...
		<div class="row">
			<div class="block">
				<img src="HE_logo.png" border='0' title="Human Ecosystems" alt="human ecosystems" />
			</div>
			<div class="block">
				<h1>Human Ecosystems</h1>
				<h2>the real-time lives of cities</h2>
			</div>
		</div>
		...
		<div class="row">
			<div class="block">
				<a href="ecosystem/viz/index.php?w=rome" title="Rome's Human Ecosystem" class="ecosystem-link">ROME</a>
			</div>
			<div class="block">
