        ...
        var styles = [
  {
    ...
    "stylers": [
      ...
      function initHeatmaps(){
        ...
        heatmaps["all"].setOptions( {radius: 60, opacity: 0.7, dissipating: true });
      ...
      var getEmotionsForMap = function(){
        ...
        $.getJSON("../../API/getGeoLatestContent.php?w=" + project)
            .done(function(data){
                ...
                for(var i = 0; i<data.length; i++){
                  datas[  "all"  ].push(  new google.maps.LatLng(  data[i].lat , data[i].lng   )  );
                ...
                heatmaps["all"].setData(datas["all"]);
