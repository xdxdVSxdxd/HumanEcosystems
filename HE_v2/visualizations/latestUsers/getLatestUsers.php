...
function findUser($un,$dbh){
	...
	return $found;
		...
		$q1 = "SELECT DISTINCT u.id as id, u.nick as nick, u.profile_url as pu FROM users u, content c WHERE c.research='" . $research_code . "' AND u.nick=c.nick ORDER BY id DESC LIMIT 0,100";
